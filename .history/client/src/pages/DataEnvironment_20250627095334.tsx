      ...
      {tab === "ontology" && (
        <div>
          ...
          <div className="flex justify-end mb-2">
            ...
            <select id="entity-select" className="border rounded px-3 py-1 text-sm">
          ...
          {/* Force-Directed Graph Visualization (static SVG mockup) */}
          <div className="bg-white rounded-xl border p-6 mb-6 shadow-sm">
            <div className="font-semibold mb-2">Predictive Maintenance Relationships</div>
            <div className="flex items-center gap-4 mb-2">
            ...
            <div className="relative w-full h-72">
              {/* SVG force-directed graph mockup */}
              <svg width="100%" height="100%" viewBox="0 0 500 260">
                {/* Edges */}
                <line x1="250" y1="130" x2="100" y2="60" stroke="#bbb" strokeWidth="2" markerEnd="url(#arrow)" />
                <line x1="250" y1="130" x2="400" y2="60" stroke="#bbb" strokeWidth="2" markerEnd="url(#arrow)" />
                <line x1="250" y1="130" x2="100" y2="200" stroke="#bbb" strokeWidth="2" markerEnd="url(#arrow)" />
                <line x1="250" y1="130" x2="400" y2="200" stroke="#bbb" strokeWidth="2" markerEnd="url(#arrow)" />
                <line x1="250" y1="130" x2="250" y2="40" stroke="#bbb" strokeWidth="2" markerEnd="url(#arrow)" />
                {/* Arrow marker */}
                <defs>
                ...
                {/* Nodes */}
                {/* Central node */}
                <circle cx="250" cy="130" r="28" fill="#2563eb" />
                <text x="250" y="135" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="bold">Predictive</text>
                <text x="250" y="150" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="bold">Maintenance</text>
                {/* Other nodes */}
                <circle cx="100" cy="60" r="20" fill="#22c55e" />
                <text x="100" y="65" textAnchor="middle" fill="#fff" fontSize="10">Supply Chain</text>
                <circle cx="400" cy="60" r="20" fill="#22c55e" />
                <text x="400" y="65" textAnchor="middle" fill="#fff" fontSize="10">Digital Twin</text>
                <circle cx="100" cy="200" r="20" fill="#22c55e" />
                <text x="100" y="205" textAnchor="middle" fill="#fff" fontSize="10">Quality Insp.</text>
                <circle cx="400" cy="200" r="20" fill="#22c55e" />
                <text x="400" y="205" textAnchor="middle" fill="#fff" fontSize="10">Design Opt.</text>
                <circle cx="250" cy="40" r="20" fill="#22c55e" />
                <text x="250" y="45" textAnchor="middle" fill="#fff" fontSize="10">Knowledge Mgmt</text>
              </svg>
              {/* Zoom, filter, settings icons */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl border p-4 shadow-sm">
              <div className="font-semibold text-blue-700 text-sm mb-2">Entity Schema: Predictive Maintenance</div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="font-bold">Predictive Maintenance</div>
                <span className="ml-2 bg-gray-100 text-gray-700 px-2 py-0.5 rounded-full text-xs font-semibold">1,245,000 instances</span>
              </div>
              <div className="text-gray-600 text-sm">Sensor, engine, and maintenance data for failure prediction and reliability.</div>
            </div>
            <div className="bg-blue-600 rounded-xl p-4 flex items-center gap-3 shadow-sm">
              ...
              <div>
                ...
                <div className="text-white text-xs">1,245,000 instances</div>
              </div>
            </div>
          </div>
        </div>
