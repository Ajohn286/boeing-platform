...
function OntologyView() {
  const [selectedEntity, setSelectedEntity] = useState('predictive');
  const [selectedNode, setSelectedNode] = useState(airbusEntities[0]);
  ...
  const handleEntityChange = (e) => {
    ...
    setSelectedNode(airbusEntities.find(ent => ent.id === id));
  };
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl border p-6 mb-6 shadow-sm">
        <div className="font-semibold mb-2">{selectedNode.name} Relationships</div>
        <div className="flex items-center gap-4 mb-2">
        ...
        <div className="relative w-full h-72">
          <ForceGraph2D
            ...
            nodeAutoColorBy={node => node.id === selectedEntity ? 'selected' : 'group'}
            ...
            cooldownTicks={50}
            onEngineStop={e => e && e.zoomToFit && e.zoomToFit(400)}
          />
