...
export default function AgenticEngine() {
  ...
  const startAIChatSequence = () => {
    const messages = [
      ...
      { agent: "Structural Analysis Agent", message: "Initial assessment shows 4.5 cm crack in landing gear strut with 94% confidence. Visual segmentation detected consistent anomaly on frame 45. This requires immediate grounding per Airbus Manual Section 05-10.", section: "summary" },
      ...
      { agent: "Predictive Analysis Agent", message: "Agreed. This decision aligns with Airbus safety protocols and predictive maintenance best practices. Work order #LG20250711 should be processed immediately with high priority status.", section: "outcome" },
      { agent: "Maintenance Decision Agent", message: "Consensus reached. Aircraft A220 grounded immediately. Work order #LG20250711 generated for landing gear strut replacement. Engineering oversight team notified via Expert Marketplace.", section: "outcome", final: true }
    ];
      ...
      setTimeout(() => {
        ...
        if (index === 4) { // After Audio Analysis Agent reviews maintenance transcript
          setMaintenanceDecisionText({
            summary: "Following a full investigation of the A220 landing gear structural integrity, a 4.5 cm crack has been identified in the strut with 94% confidence through visual and audio analysis.",
            determination: "Structural crack exceeds 2 cm safety threshold per Airbus Manual Section 05-10. Historical data shows previous repair 8 months ago with accelerated fatigue patterns from severe weather exposure.",
        ...
        if (msg.final) { // Final consensus reached
          setMaintenanceDecisionText({
            summary: "Following a full investigation of the A220 landing gear structural integrity at CDG Airport, the AI agents have reached consensus on maintenance requirements.",
            determination: "Aircraft must be grounded immediately due to 4.5 cm structural crack exceeding safety thresholds. Airbus SRM mandates immediate replacement with no exceptions for temporary repairs.",
                ...
                <div className="space-y-6 text-sm text-gray-700">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-4">
                      <li>Aircraft: Airbus A350-900 (Registration: F-HZGK)</li>
                  ...
                  >
                    ...
                    {maintenanceDecisionText.summary !== "Analysis in progress..." && (
                      <ul className="list-disc list-inside space-y-2 ml-4 text-sm text-gray-600">
                        <li>Structural crack of 4.5 cm identified in landing gear strut through pixel-level segmentation analysis with 95% accuracy validated against Airbus-specific training data.</li>
                  ...
                  >
                    ...
                    {maintenanceDecisionText.outcome !== "Awaiting consensus from AI agents..." && maintenanceDecisionText.outcome.includes("work order") && (
                      <ul className="list-disc list-inside space-y-1 ml-4 mb-3 text-sm text-gray-600">
                        <li>Aircraft A220 must be grounded immediately due to structural crack exceeding 2 cm safety threshold per Airbus Manual Section 05-10.</li>
